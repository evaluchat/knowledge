...
| [GitHub research workspaces — threat model](/designs/github-research-threat-model.en.md) | draft | Platform security threat model for v0.8 private GitHub research workspaces: leak vectors, OAuth/token threats, rotation failure modes, and verification obligations |
